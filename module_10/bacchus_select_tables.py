...
print()
print("--- Wine Production Table ---")
cursor.execute('SELECT * FROM wine_production')
cursorVariable = cursor.fetchall()
print("Wine-Production" + str(cursor.column_names))
for rows in cursorVariable:
    print(rows[0], rows[1], rows[2], rows[3])
