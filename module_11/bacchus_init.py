...
initCurs.execute("CREATE TABLE employee_clocks (clock_id INT NOT NULL AUTO_INCREMENT,employee_id INT NOT NULL,department_id INT,clock_in DATETIME,clock_out DATETIME,PRIMARY KEY(clock_id),CONSTRAINT fk_employee FOREIGN KEY(employee_id) REFERENCES employee(employee_id));")
...
# James Bailey added wine_production information
